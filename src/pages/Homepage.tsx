...
import WomenAndMan from '../assets/images/womenandman.png';
    ...
    <main className="container-landing">
      ...
      <motion.div className=" w-full  bg-primary/5  z-20 flex items-center py-5 justify-center flex-col h-screen " initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 2 }}>
        <div className="flex flex-col items-center font-workSans  h-full ">
          <h1 className="text-2xl text-center  text-shadow leading-relaxed font-semibold text-slate-800 text-shadow-white font-greatVibes">
            Kamis <br />
            21 November 2024
          </h1>
          ...
          <div className=" flex justify-center items-center">
            ...
            {/* The image */}
            <img src={WomenAndMan} alt="women and man" className="-z-10 border-4 rounded-full mt-5" />
