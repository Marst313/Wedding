  ...
  return (
    <div className=" ">
      ...
      <motion.div className="description max-w-sm mx-auto z-20 relative px-5 rounded-tr-2xl h-screen rounded-bl-2xl font-workSans mt-32" initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ duration: 2 }}>
        ...
        <p className="text-slate-900 text-xs text-center leading-loose mt-1 font-workSans font-normal ">Tanpa mengurangi rasa hormat, kami bermaksud mengundang Bapak/Ibu/Saudara/i pada acara resepsi pernikahan kami pada :</p>
      ...
      <motion.img src={topRight} alt="bottom left" className="absolute sm:bottom-0 -left-1 z-20 rotate-180 -mt-[31rem] w-48 " initial={{ x: -500, rotate: 180 }} animate={{ x: 0 }} transition={{ duration: 2 }} />
      <motion.img src={topLeft} alt="bottom right" className="absolute  sm:bottom-0 -right-0 z-20 rotate-180  -mt-[31rem] w-48" initial={{ x: 500, rotate: 180 }} animate={{ x: 0 }} transition={{ duration: 2 }} />
    </div>
  );
};
